...
LOGGER_ID = int(getenv("LOGGER_ID", -1003786474330))

# Vars For API End Pont.
YTPROXY_URL = getenv("YTPROXY_URL", 'https://tgapi.xbitcode.com') ## xBit Music Endpoint.
YT_API_KEY = getenv("YT_API_KEY" , 'xbit_IL6WswZAWKfMHZ1t_V7DTPEIkXuIrSf5') ## Your API key like: xbit_10000000xx0233 Get from  https://t.me/tgmusic_apibot
...
# ======================================================
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/arvind021/aj")
